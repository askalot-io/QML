# NPHS_Population_Health

- **source**: NPHS_Population_Health.pdf
...
DEMO_Q4      What is ... 's date of birth?
             DD/MM/YY (Age is calculated and confirmed with respondent.)
*DHC4_DAT*
*DHC4_DOB*
*DHC4_MOB*
*DHC4_YOB*
...
DEMO_Q6      What is ... current marital status?
             *(Note: if age < 15, marital status is automatically = single)*
*DHC4_MAR*
                  ___     Now married
                  ___     Common-law
...
Note: In computer-assisted interviewing the options Don't Know (DK) and Refusal (R) are allowed on every question.

H05-P1          Who is providing the information for this person's form?
AM54_SRC        ________________________________

Two-Week Disability

TWOWK-INT     The first few questions ask about ...(r/'s) health during the past 14 days.

TWOWK-Q1      It is important for you to refer to the 14-day period¹ from %2WKSAGO% to %YESTERDAY%.
TWC4_1         During that period, did ... stay in bed at all because of illness or injury including any nights spent
...
TWOWK-Q3      (Not counting days spent in bed) During these 14 days, were there any days that ... cut down on
TWC4_3         things you/he/she normally do/does because of illness or injury?
...
UTIL-INT       Now I'd like to ask about ...(r/'s) contacts with health professionals during the past 12 months².
...
HCC4_8E         ___     Any other reason  (Specify_______________)
...
HCC4_SC        (Specify____________________)
and
...
*RAC4_3C*
                    ____________________(25 spaces) (Go to RESTR-Q5)
...
CHRON-CNT    If age <12 go to next section.
...
*CCC4_1S*        (s)          Cataracts?
*CCC4_1T*        (t)          Glaucoma?
*CCC4_1V*        (u)          Any other long term condition?   (Specify _______________)
*CCC4_NON*       (v)          None
                              DK, R    (Go to next section)
...
*SDC4_5I*    ___    Italian               *SDC4_5S*    ___    Other (Specify_______)
*SDC4_5J*    ___    Korean
...
*SDC4_6I*          ___     Italian               *SDC4_6S*          ___     Other (Specify___________)
*SDC4_6J*          ___     Korean
...
*SDC4_7L*          ___     Other (Specify_________)
...
*EDC4_6*       school, trade or vocational school, CEGEP or other post-secondary institution?
...
*EDC4_7*                    (Do not read list.  Mark one only.)
...
LFS-I2         The next section contains questions about jobs or employment which ... have/has had during the
               past 12 months². Please include such employment as part-time jobs, contract work, baby sitting
...
*LFC4_EnC*
                ______________________ (50 chars)
...
*LFC4_5nM*
*LFC4_5nD*      MM/DD/YY
*LFC4_5nY*      DK, R     (Go to next section)
...
*LFC4FMN*       (Answer will be chosen from roster of jobs.)
...
LFS-C18        If LFS-Q1 = 2 or 3 or any one of LFS-Q6.1 to LFS-Q6.6 = 1 (currently working) then %LFS-WORK% =1;
...
*INC4_2*          (Do not read list.  Mark one only.)
...
*AM64_SRC*      ________________________________
...
*WHC4_33*             (Read list.  Mark one only.)
              ...
              ___   Breast problem
              ___   Checkup, no particular problem
              ___   Other (specify____________)
...
ALCO-Q1     During the past 12 months², have/has ... had a drink of beer, wine, liquor or any other alcoholic
*ALC4_1*    beverage?
...
*ALC4_2*             (Do not read list.  Mark one only.)
...
*ALC4_7I*     ___          Affected friendships or social relationships
...
*ALC4_7M*     ___          Other (specify_______________)
...
PHYS-Q1        Have you done any of the following in the past 3 months³?
                (Read list.  Mark all that apply.)
...
*PAC4_1L*    ___    Exercise class/aerobics       *PAC4_1V*    ___    None
                                                               DK, R  (Go to next section)
...
*IJC4_3*       broken bone or burn.
              ...
              __       Multiple injuries
              __       Broken or fractured bones
              __       Burn or scald
              __       Dislocation
              __       Sprain or strain
              __       Cut or scrape
              __       Bruise or abrasion
              __       Concussion
              __       Poisoning by substance or liquid
              __       Internal injury
              __       Other (specify_______________)
...
*IJC4_4*             (Do not read list.  Mark one only.)
              ...
              __       Legs or feet
              __       Back or spine
              __       Trunk (excluding back or spine) (including chest, internal organs, etc.)

INJ-Q5        Where did the injury happen?
*IJC4_5*             (Do not read list.  Mark one only.)

              __       Home and surrounding area
              __       Farm
              __       Place for recreation or sport
                       (e.g. golf course, basketball court, playground (including  school))
              __       Street or highway
              __       Building used by general public (e.g. hotel, shopping plaza, restaurant, office building,
                       school)
              __       Residential institution (e.g. hospital, jail, etc.)
              __       Mine
              __       Industrial place or premise (e.g. dockyard)
...
INJ-Q8         We would like to know what precautions s/he/is taking, if any, to prevent this kind of injury from
...
*PY_4_H1*         the feeling that you don't really care about what goes on around you?
...
*PY_4_H2*         often in the past were you surprised by the behaviour of people whom you thought you knew well?
...
PY_4_H5     feeling you are in an unfamiliar situation and don't know what to do?
...
PY_4_H10    feelings that you're not sure you can keep under control?
...
*PY_4_H11*   now your life has had no clear goals or purpose or has it had very clear goals and purpose?
...
*PY_4_H12*   in the right proportion.  When something happens, you generally find that you overestimate or
...
*HSC4_4*        *without* glasses or contact lenses ?
...
*HSC4_5*        street *with* glasses or contact lenses?
...
*HSC4_8*        quiet room *without* a hearing aid ?
...
*HSC4_24*     of limitations in the use of hands or fingers?
...
DRUG-Q1       In the past month⁴, did ... take any of the following medications?
                        (Read list.  Mark all that apply.)
...
*DGC4_4*       drinks which people use to prevent illness or to improve or maintain their health. Do/Does ... use
               any of these or other health products?
...
MHLTH-Q1g    We have just been talking about feelings and experiences that occurred to different degrees during
               the past month.  Taking them altogether, did these feelings occur *more often* in the past month than
               is usual for you, *less often* than usual , or *about the same* as usual?
*MHC4_1G*          (Do not read list.  Mark one only.)
...
MHLTH-Q1k   In the past 12 months², have you seen or talked on the telephone to a health professional about
*MHC4_1K*   your emotional or mental health?
...
*MHC4_3*    feelings were worst. During that time how long did these feelings usually last?
                (Read list.  Mark one only.)
...
*MHC4_17*   had the most complete loss of interest in things. During that 2-week period, how long did the loss
...
*MHC4_20*           (Do not read list.  Mark one only.)
...
*SSC4_1*      social groups, community centres, ethnic associations or social, civic or fraternal clubs?
...
*SSC4_2*      months? If you belong to many, just think of the ones in which you are most active.
                      (Read list.  Mark one only.)
...
*RTP4_11*      sufficient reasons for doing so?
...
*RTP4_12A*     ___           Ask the dentist exactly what he is doing
*RTP4_12B*     ___           Take a tranquilizer or have a drink before going
*RTP4_12C*     ___           Try to think about other things, like pleasant memories
*RTP4_12D*     ___           Have the dentist tell you when you would feel pain
*RTP4_12E*     ___           Try to sleep
*RTP4_12F*     ___           Watch all the dentist's movements and listen for the sound of the drill
*RTP4_12G*     ___           Watch the flow of water from your mouth to see if it contained blood
*RTP4_12H*     ___           Do mental puzzles in your mind
*RTP4_12I*     ___           Other (Specify_________)
...
NOTE:
The data for the 1994-95 NPHS selected child 0 to 11 years old were collected by the National Longitudinal Survey of Children and Youth (NLSCY).  The data were picked up from NLSCY and were reformatted to fit into the NPHS processing system. The question names used here were assigned during processing to be consistent with 1996. When question wording was similar, the wording from NPHS was used. If the wording was sufficiently different that concepts may vary, the NLSCY wording was used.  See National Longitudinal Survey of Children Survey Instruments for 1994-95 Data Collection, Cycle 1 Catalogue No. 95-01 for exact order and wording of the questions.  For complete details on the 1994-95 sample design , see *Sample Design of the National Population Health Survey , Health Reports 1995, Vol. 7, No.1.*
...
KGH-Q5        How much does %he/she% weigh?
              ...
              (ENTER AMOUNT ONLY.)            (MIN: 1) (MAX: 300)
              DK, R   (Go to next section)

KGH-C5 INTERVIEWER:  WAS THAT IN POUNDS OR IN KILOGRAMS?
...
*HCC4_2I*      f)    A psychiatrist or psychologist                           0      366
*HCC4_2H*      g)    Child welfare worker or children's aid worker            0      366
*HCK4_2OT*     h)    Any other person trained to provide treatment or counsel, for example a speech therapist,
                     a social worker                                          0      366
...
*HSC4_1*      contact lenses?

              1          YES     (Go to KHS-Q4)
              2          NO

KHS-Q2        Is %he/she%  us*ually* able to see clearly, and without distortion, the words in a book *with* glasses or
*HSC4_2*      contact lenses?
...
KHS-Q22     Does %he/she% require the help of another person because of limitations in the use of hands or fingers?
*HSC4_22*
               1          YES
               2          NO          (Go to KHS-Q24)
