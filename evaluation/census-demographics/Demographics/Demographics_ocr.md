...
FNAME
      ...
      (What are the names of all persons living or staying here? / What is the name of the
       next person)
...
NROS2B
      ...
      At this point count additional people. You will interview only those household members 15
       years old or older who are listed.
      Are there any other persons 15 years old or older now living or staying there? (Who
...
MAWAY
      ...
      Have I missed anyone who usually lives here but is away now -traveling, at school, or
      in a hospital?
...
OWNREN1
    ...
    What is the name of the person or one of the persons who owns or rents that home?
     ...
     Enter line number (1-16) if current HH member Enter (0) if owner(s)/renter(s) not a
    household member
...
S_SUBFAM
    ...
    Earlier you said that (name of person talking about) (was/were) not related to
    (reference person's name/you). (Are / Is) (name of person talking about) related to
...
PAR1TYP
       ...
       (Are / Is) (name of person talking about) (your / mother's name) biological, step, or
       adopted child?
...
PAR2TYP
    ...
    (Are / Is) (name of person talking about) (your / father's name) biological, step, or
    adopted child?
...
PARENT2
    ...
    (REF_FNAME ^REF_LNAME’s) parent is also (name of person talking about)’s
...
VERIFY_AGE
       ...
       As of last week, that would make (name/you) (approximately (AGE)/ less than 1 / over
       98 / AGE) years old. Is that correct?
...
AGEGSS
       ...
       Even though you don’t know (name's/your) exact birthdate, what is your best guess as
       to how old (you/he/she) (was/were) on (your/his/her) last birthday?
...
PREMARTL
       ...
       Since our last interview, has any household member had any changes in his or her
       Marital Status?
...
EDUCA
    ...
    What is the highest level of school (name/you) (have/has) completed or the highest
    degree (name/you) (have/has) received?
...
DIPGED
    ...
    People can get a High School diploma in a variety of ways, such as graduating from
    High School or by getting a GED or other equivalent. How did (name/you) get
    (your/his/her) High School diploma?
...
CERT1
      ...
      (Does/do) (name/you) have a currently active professional certification or a state or
      industry license? Do not include business license, such as a liquor license or vending
      license.

      (Read if necessary: a professional certification or license shows you are qualified to
      perform a specific job. Examples include a real estate license, a medical assistant
      certification, a Teacher License or an IT certification. Only include certifications or
      licenses obtained by an individual.)

        1. Yes
        2. No
CERT2

      Were any of (your/his/her) certifications or licenses issued by the federal, state, or local
      government?
...
ORISPN
      ...
      (Are / Is) (name/you) Mexican, Mexican American, or Chicano, Puerto Rican, Cuban,
      Cuban American, or another Hispanic, Latino, or Spanish origin; for example,
...
RACE
       ...
       I am going to read you a list of five race categories. You may choose one or more
       races. For this survey, Hispanic origin is not a race. (Are/Is) (NAME/you) White;
       Black or African American; American Indian or Alaska Native; Asian; OR Native
...
RACEAS
       ...
       Which of the following Asian groups (are/is) (you/he/she)? Asian Indian, Chinese,
       Filipino, Japanese, Korean, Vietnamese, or another Asian group?
...
RACEPI
    ...
    (you/he/she)? Native Hawaiian; Guamanian or Chamorro; Samoan; or another Pacific
    Islander group?
