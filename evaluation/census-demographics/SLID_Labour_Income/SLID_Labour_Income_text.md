...
Question numbers:   For each section, the question numbers generally refer to the actual numbers used in the software and which appear on an interviewer's computer screen.  Text in capital letters is read, as worded, by the interviewer.  Those questions in lower case with "Interviewer:" at the beginning are questions to be answered directly by the interviewer without asking the respondent.  Those questions with "Internal logic:" at the beginning are questions answered directly by the computer.  They are invisible to the interviewer, and are required to direct question flow.

Pre-fill items:  These are items specific to each respondent's interview.  The software adds the relevant information into the question, making it simply a matter of reading for the interviewer.  Prefill items (given in square brackets [ ]) include:
...
Headers:  For each question, important information is noted at the top of the screen.  In this document, this information is given at the beginning of each section description.


Ranges: Hard ranges are specified for some of the questions.  The hard range gives the highest and lowest acceptable response values.  The system will not accept  a number outside the range.

A soft range specifies an upper and lower limit which if exceeded will result in a probe to confirm that the amount entered is correct.  If it is correct, the entry is allowed as long as it is not outside the hard range.  No soft ranges exist for the Preliminary Interview questions.


Dates:  All dates are entered by number in boxes, using the DD/MM/YY format. When a numeric value for month (1 to 12) is entered, the appropriate text flashes. For example, if the interviewer enters a date 26/09/93, the screen shows:  26  09 September  1993.


Function Keys:  Interviewers have a number of keys on the computer (function keys) which are available to provide them with the following options.
...
**EMPPRE-J1.Q7A   IN WHICH MONTHS OF [reference year] DID
                  ...
                  Last worked                Go to EMPPRE-J1-Q7E
...
BASED ON THE DATE OF BIRTH AND MARITAL STATUS REPORTED EARLIER IN THE INTERVIEW.
...
Working in Jan 94?
   yes →
   no → Permanently unable?
            yes →
            no → Q2 Had a job but not at work?
                     yes → Q3 Reason for absence → school/educ leave →
                                Q4 Absence paid or unpaid?
                                   N4 Temporary layoff?
                                      No →
                                      Yes →
                     no/dk/r →
                                Q5 Ever worked?
                                   yes/dk/r → Q6/N6 When last worked in past 5 years?
                                                  yes → Q7 Reason for job separation
                                                  no →
                                   no →
                                N7 Permanently unable?
                                   yes →
                                   no →
Q8 Looked for work in 01 94?
   yes → Q9 What methods?
   no/dk/r → Q10 Looked in 6 mo before that?
                  yes/dk/r → Q11 Reason for not looking in 01/94
                  no →
...
J1.Q2          J1.Q2A
Date first worked    Date must be after answer in Q6
for this employer

J1.Q3                                                J1.Q7A/J1.Q7B
Industry → J1.Q4 Occupation → J1.Q5 Main duties → J1.Q6 COW → Months worked in 93 → go to J1.Q8
...
J1.Q12                          earnings
         Weeks per month
                         ...
                         J1.Q13
         yes        Tips, bonuses,    no/dk/r
                         etc
J1.Q14
yes/dk/r    Included in      no
            J1.Q11A?              J1.Q15
                                  How much?
                              ...
                              J2.Q1
         yes         More than       no/dk/r
                     one job in
                        93?

J2.Q2                                              N12
         Employer name                  yes    Age 65+?    no


J2.Q3 - J2.Q16                                              Q12
         Repeat job description          no/dk/r       In school in    yes
         questions from job 1                           01/94?
...
Q1A                                                          Page 1 of 1
                    Did you ever
          yes       work full-time?      no/dk/r
Q1B
     How many years
     since you first
     started working?
                              dk/r/ or if answer is zero
                    if answer is 1

Q2A
          Were there any years
  yes     when ... did not work        no/dk/r
          at all at a job or
          business?
Q2B                              Q3
  How many years did        Worked at least          yes/dk/r
  you not work at all?      six months every
                    no      year?
                                         Q4A   How many years did
                                               you work full-time?
Q5A
     Did you work at least 6
     months in every one of              dk/r
     those years?
                                   Q4B
Q6A                                    How many years did
     How many years did                you work part-time?
     you work full-time?
                                   Q4C
Q6B                                    How many years did you
     How many years did                work some of each?
     you work part-time?
                                   N4
Q6C                           no   Does Q4A+B+C     yes
     How many years did              = Q1B?
     you work some of
     each?                    error
                              message  Q4D
          N6
  no   Does Q6A+B+C    yes                              go to
         = Q1B?                                       DEMPRE-N1
Q6D
  error message
...
Read intro   Q1A
                              ...
                              N1
               Attached    Marital Status    Not attached

  Common law    Marital Status    Married         Separated/              Other
     Q5                            Q2B            Divorced    Marital Status
                                                     Q1
Date started                  Date of marriage
living together                                  Date of
                                                 separation
              Q6
        no   Ever been   yes
             married              Go to Q3
           yes/dk/r    Q8                                          Marital Status    Single
     Q9                  First    no                                                    Q7
                        marriage?   Q10
Date of marriage                                                              Date
                              Date of first                                  widowed
                              marriage
                                                    Q2                       Go to Q8
                                              Date of
                                              marriage
                         Incorrect dates   verify dates    Correct dates
                              Q2A                                    Q3
                         error message                          First        yes/dk/r
                                                               marriage?
...
2/2/94                                                                    Page 2 of 2
  ...
  0       How many       1+
          ...
          born?           Year of birth
               ...
               Q14
    yes   Any other children      no/dk/r
          adopted or raised?
...
2/2/94
              ...
              00          How many years of elementary and          dk/r
    ...
    Q17
              yes       Is answer >          no
                        (%age% - 5)
    Q1A    error message                                                  Q2
                                                               In which province did you
                                                               get most of your schooling?
                    ...
                    Q4
          no        Excluding university,          yes/dk/r
                    enrolled in any other
                    kind of school?
    Go to                                    Q5
    Q12        no        Received certificates or          yes/dk/r
                         diplomas?
                                                                         Q6
               Go to                  dk/r
               Q11                              For your most recent
                                                certificate, what type of
                                                school?

                                                                         Q7
                                                How long to complete program?
...
Q9   In which year did you receive
     certificate or diploma?                    dk/r

          Is answer between
     yes  [%current year% - (%age% - 14)] and   no
          [*current year% - (%age% - 20)]
Q9A                                                        Q10
     Error message                                         Major field of study

                                                                          Q11
                                                           In total, how many    dk/r
                                                           years of schooling?
Q11A
     Error message        yes   Is answer between >   no
                                (%age% - 14)
                                                                          Q12
                                                      yes/dk/r            Ever enrolled in    no
                                                                          university?
          Q13
dk/r      How many years of university?           00

               Is answer > (%age% - 14)    yes        Q13A
          no                                           Error message

Q14
     What degree did ... get?          none
Q14A
     Specify                                                    Q17
                         Q15                                    Highest level of education of mother
     What year received highest degree?

Q16  Major field of study?

                                                Q18
                                                Highest level of education of father

                                                end of preliminary interview
