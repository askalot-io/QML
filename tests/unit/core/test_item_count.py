...
is to parse real QML the way the loader does, so fixtures exercise the genuine
parse-and-flatten path. The helper takes CONTENT (QML is canonical in the
document store, plan 2026-07-21-001 U5), so the fixtures are read here and
handed in as text.
"""
